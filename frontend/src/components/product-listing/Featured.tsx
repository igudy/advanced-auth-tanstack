    ...
    <div className="sm:my-5 md:my-5 xsm:my-5 my-32 sm:text-center relative">
      <div className="flex flex-row sm:flex-col-reverse md:flex-col-reverse left-0 justify-between">
        <div className="basis-1/2">
          <div className="relative text-xl sm:text-md xsm:text-md sm:text-center md:text-center right-0 mt-4 text-left">
            ...
            <p className="text-slate-800 text-md my-1 sm:text-sm xsm:text-sm md:text-sm lg:text-sm xl:text-lg mb-3">
              {featured.text}
            </p>
